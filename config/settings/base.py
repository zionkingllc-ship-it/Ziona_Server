...
AUTH_CHANGE_PASSWORD_REQUIRES_OTP = env.bool("AUTH_CHANGE_PASSWORD_REQUIRES_OTP", default=False)
...
ACCOUNT_DELETION_PURGE_MAX_RETRIES = env.int(
    "ACCOUNT_DELETION_PURGE_MAX_RETRIES",
    default=5,
)
...
GCP_SIGNED_URL_EXPIRY = env.int("GCP_SIGNED_URL_EXPIRY", default=900)
...
MEDIA_RESUMABLE_UPLOADS_ENABLED = env.bool("MEDIA_RESUMABLE_UPLOADS_ENABLED", default=False)
MEDIA_RESUMABLE_VIDEO_MAX_UPLOAD_MB = env.int("MEDIA_RESUMABLE_VIDEO_MAX_UPLOAD_MB", default=500)
MEDIA_RESUMABLE_UPLOAD_RECOMMENDED_CHUNK_MB = env.int(
    "MEDIA_RESUMABLE_UPLOAD_RECOMMENDED_CHUNK_MB", default=8
)
MEDIA_RESUMABLE_UPLOAD_SESSION_TIMEOUT_SECONDS = env.int(
    "MEDIA_RESUMABLE_UPLOAD_SESSION_TIMEOUT_SECONDS", default=60
)
...
MEDIA_PROCESS_TASK_SOFT_TIME_LIMIT_SECONDS = env.int(
    "MEDIA_PROCESS_TASK_SOFT_TIME_LIMIT_SECONDS", default=45
)
MEDIA_IMAGE_TASK_SOFT_TIME_LIMIT_SECONDS = env.int(
    "MEDIA_IMAGE_TASK_SOFT_TIME_LIMIT_SECONDS", default=150
)
...
MEDIA_CLEANUP_TASK_SOFT_TIME_LIMIT_SECONDS = env.int(
    "MEDIA_CLEANUP_TASK_SOFT_TIME_LIMIT_SECONDS", default=150
)
...
# `ziona.app` used to 308 to `www.ziona.app`, which is why www was the target;
# the apex now serves directly and proxies /.well-known/* plus /post/* and
# /profile/* to this backend, so it is the canonical host again. It must stay in
